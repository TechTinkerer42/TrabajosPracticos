...
un estimador insesgado de $p$, se puede calcular al error cuadràtico
medio como


$r[\hat{\mu},\mu]=V(\hat{\mu})+b_{\mu}(\hat{\mu})=V(\hat{\mu})=\frac{V(x_{i})}{n}=\frac{\sigma^{2}}{n}=\frac{(npq)^{2}}{n}=80*(0.85*(1-0.85))^{2}=1.30$
...
\item 
\begin{figure}[H]
\centering{}\includegraphics[scale=0.25]{TotalWeightVsBrainWeight}\caption{Peso del cerebro y peso total para cada medición en brains.txt{*}}
\end{figure}
...
\begin{figure}[H]
\hspace{3cm}\includegraphics[scale=0.5]{TwVsBw}\caption{Peso total en Kg Vs peso del cerebro en G{*}{*}}
\end{figure}
...
\begin{lyxcode}
\begin{figure}[H]
\centering{}\includegraphics[scale=0.75]{logBrains}\caption{Logaritmo de ambas mediciónes y la línea que mejor los aproxima}
\end{figure}
...
\begin{lyxcode}
\begin{figure}[H]
\centering{}\includegraphics[scale=0.75]{outLayerRemovidos}\caption{Logaritmo de ambas mediciónes y la línea que mejor los aproxima}
\end{figure}
